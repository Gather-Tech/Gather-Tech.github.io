...
### [普段Vue.jsでフロントエンド開発するときの構成と運用時のポイント : Qiita](http://qiita.com/potato4d/items/55a60f21c26bf889afd5)

Vue.jsで開発するときの開発環境、プロジェクトの構成などのポイントがまとめられている。

### [js-stack-from-scratch: Step-by-step tutorial to build a modern JavaScript stack from scratch](https://github.com/verekia/js-stack-from-scratch)

モダンなJavaScriptスタックのステップバイステップのチュートリアル。
...
### [watson-developer-cloud/ios-sdk: GitHub](https://github.com/watson-developer-cloud/ios-sdk?utm_campaign=This%2BWeek%2Bin%2BSwift&utm_medium=email&utm_source=This_Week_in_Swift_108)
