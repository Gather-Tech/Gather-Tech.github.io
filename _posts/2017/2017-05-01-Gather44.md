...
### [リクルートがAIをまさかの無料公開。さっそくすべてのAPIを試しまくってみた : BITA デジマラボ](https://bita.jp/dml/recruit_artapi_)

リクルートが公開したA3RTについて。AIライブラリというよりはAPI群。テキストレコメンドやテキスト分類、文章校閲などのAPIが用意されている。
...
### [『 データ分析基盤Night #2 』に参加してきた #データ分析基盤Night : 試纏](http://try-and-matome.hatenablog.jp/entry/20170426_report-data-analysis-infrastructure-night-vol-2)

データ分析基盤Night#2の参加レポート。FiNC、free、メルカリのデータ分析基盤についての発表内容がまとめられている。
...
### [mozilla/positron : GitHub](https://github.com/mozilla/positron)

FirefoxのレンダリングエンジンGeckoをベースにしたElectron。mozillaが進めている。
...
### [younatics/YNSearch: 🔍 Awesome fully customize search view like Pinterest written in Swift 3 + Realm support!](https://github.com/younatics/YNSearch)

Pinterest風の検索ビューを提供するSwiftライブラリ。Realmの利用をサポートしている。
