...
Kubernetesクラスターの環境構築の手順書。Terraformファイルも付いているのでお手軽。
...
### [jingweno/godzilla: GitHub](https://github.com/jingweno/godzilla)

ES2015からGo langへのトランスパイラ。
...
### [Ludus · Limitless creativity for your slides](https://ludus.one/)

クールなスライドが作成できるオンラインサービス。有料のチームプランもある。
