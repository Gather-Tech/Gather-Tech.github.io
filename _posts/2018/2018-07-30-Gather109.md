...
- [Google Cloud Next ‘18 Day 1 Keynote : ブチザッキ](https://buchizo.wordpress.com/2018/07/25/google-cloud-next-18-day-1-keynote/)
...
### [hackmdio/codimd: GitHub](https://github.com/hackmdio/codimd#installation)

リアルタイム共有機能付きのMarkdownエディタ。
...
### [KanbanMail – A Kanban Board for your emails](https://kanbanmail.app/)

Emailをカンバンボードで管理できるサービス。
...
### [Stitches - A HTML template generator using functional css](http://stitches.hyperyolo.com/)

要素をドラッグ＆ドロップで組み合わせて画面を作り、そのHTMLとCSSを生成できるサービス。

### [Zotero | Your personal research assistant](https://www.zotero.org/)

論文やニュース記事などの文献を管理するアプリ。
