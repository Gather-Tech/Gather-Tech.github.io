...
プログラミング言語やツールのコマンドや書き方を分かりやすく比較したサイト。

### [Kyash Android で UIテストを導入した時の方針 : Konifar's WIP](http://konifar.hatenablog.com/entry/2018/08/13/180157)
...
### [Android Developers Blog: Google releases source for Google I/O 2018 for Android](https://android-developers.googleblog.com/2018/08/google-releases-source-for-google-io.html)

Google I/O 2018のAndroidアプリのソースコードが公開された。そのアーキテクチャの解説。

### [3年半でエンジニアの採用数が12倍　テモナCTOの「開き直りから始める技術広報」 : ログミー](https://logmi.jp/305691)
...
開発者がブログをやって得られることについて。時間管理の方法や習慣が身につく、フィードバックがもらえる、コミュニケーションスキルが身につくなど。
...
### [jgthms/bulma : GitHub](https://github.com/jgthms/bulma/)
...
### [calebmadrigal/trackerjacker: GitHub](https://github.com/calebmadrigal/trackerjacker)

周りのWiFiネットワークとそこに接続しているデバイスをスキャンできるツール。
