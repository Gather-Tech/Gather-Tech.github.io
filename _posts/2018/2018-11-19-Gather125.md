...
### [Building iPad Pro features in Swift : Swift by Sundell](https://www.swiftbysundell.com/posts/building-ipad-pro-features-in-swift)	

2018年モデルの新しいiPad用の機能のSwiftでの実装について。Pencilでのダブルタップ、外部ディスプレイの扱い方、キーボードショートカットなどの実装方法が解説されている。
...
### [Kubernetes Jobを用いたバッチシステムのリソース最適化　AbemaTVが抱えていた問題とその解決策 : ログミーTech](https://logmi.jp/tech/articles/320237)

Fan-Outパターン、Priority Queueパターン、Queuing Chainパターンといったバッチ処理のパターンの紹介とKubernetes Jobを使ったバッチシステムの設計について。
...
### [みてねのスクラム開発 / scrum development style in mitene : Speaker Deck](https://speakerdeck.com/_atsushisakai/scrum-development-style-in-mitene)

大きくなってしまったスクラムチームの運営について。チームを分割せずにデメリットを解決してメリットを享受することを優先させたとのこと。そのためにどのような運用をしたかについて。
...
### [heyscrumpy/tiptap: GitHub](https://github.com/heyscrumpy/tiptap)

Vue.js用のリッチテキストエディター。
...
x86エミュレータを使用してiOSデバイス上Linuxシェル環境動かすプロジェクト。
