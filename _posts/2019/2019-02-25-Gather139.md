...
### [Replacing a hot path in your app's JavaScript with WebAssembly :  Google Developers](https://developers.google.com/web/updates/2019/02/hotpath-with-wasm)	

JavaScriptのホットパス(画像描画などで遅い部分)をWebAssemblyに置きかえて高速化する方法について。TypeScriptをWebAssemblyへコンパイルするAssemblyScriptを利用、CやRustとのパフォーマンス比較など。

### [マネージドサービスだけでAzureとAWSを接続する方法。 : 技術的な何か。](http://level69.net/archives/26362)
...
### [BigQuery ML を実プロダクトで使うために調査した話 : リクルートテクノロジーズ　メンバーズブログ](https://recruit-tech.co.jp/blog/2019/02/20/bigquery_ml_research2018/)

BigQuery MLを使った価格予測モデルの作成について。BigQuery MLを使う一連の流れ、長所、注意点などがまとめられている。

### [Andrew's Blog — How many apps use Swift in 2019?](https://blog.andrewmadsen.com/post/182862756395/how-many-apps-use-swift-in-2019)

iOSアプリでSwiftが使われている割合。ゲーム以外のアプリだと57%がSwiftを使っている。2019年1月15日にApp Storeのトップ110の無料アプリをダウンロードし解析して出したとのこと。
...
### [モノレポ入門 - Gutenberg が採用するリポジトリ戦略 ： Capital P](https://capitalp.jp/2019/02/19/%E3%83%A2%E3%83%8E%E3%83%AC%E3%83%9D%E5%85%A5%E9%96%80-gutenberg-%E3%81%8C%E6%8E%A1%E7%94%A8%E3%81%99%E3%82%8B%E3%83%AA%E3%83%9D%E3%82%B8%E3%83%88%E3%83%AA%E6%88%A6%E7%95%A5/)
...
### [yarnaimo/vanilla-clipper: GitHub](https://github.com/yarnaimo/vanilla-clipper)

CSS、Web fonts、Shasow DOM、画像等も含めWebサイトを保存するツール。Puppeteeを利用。
...
### [lemire/simdjson: GitHub](https://github.com/lemire/simdjson)

サイズの大きいJSONを高速にパースできるC++ライブラリ。
