...
### [statsbotco/cube.js: GitHub](https://github.com/statsbotco/cube.js)

データ分析Webアプリを作るためのフレームワーク。データソースにはBigQueryやAWS Athenaなどが使える。
...
### [Mckinsey666/bullet: GitHub](https://github.com/Mckinsey666/bullet)	

PythonでCLIツールを作るときにプロンプトの表現をリッチにできるライブラリ。

### [remoteinterview/zero: GitHub](https://github.com/remoteinterview/zero)	

シンプルで設定がもろもろと抽象化されているWebフレームワーク。

### [wasmerio/wasmer: GitHub](https://github.com/wasmerio/wasmer)

スタンドアロンなWebAssemblyのJITランタイム。

### [kenhowardpdx/vscode-gist: GitHub](https://github.com/kenhowardpdx/vscode-gist)

gistと連携できるVS Code拡張。gistへの追加、変更、削除ができる。

### [mxcl/Workbench: GitHub](https://github.com/mxcl/Workbench)

.bash_profileなどのいわゆるdotfileを自動的にiCloudに保存してくれるMacアプリ。
