...
### [プルリクエストが最速でマージされるための７つの技 : Qiita](https://qiita.com/TsuyoshiUshio@github/items/63af5cacb3712d6f9199)

OSSにPRを送る時に意識した方が良い点について。ガイドラインに従う、コードスタイルを真似る、PRを小さくする、リポジトリオーナーやコントリビュータ間のコミュニケーションや信頼関係を大事にするなど。

### [Firebase Test labでiOSアプリのUnitTestとUITestを行う : dely engineering blog](https://tech.dely.jp/entry/2019/03/30/110000)
...
### [Quipper の Monorepo な Web アプリ開発における Git 戦略 : Quipper Product Team Blog](https://quipper.hatenablog.com/entry/2019/04/02/quipper-web-git-flow-on-monorepo)

Quipperにおけるモノレポでのgitを使った開発フローについて。PRごとにステージング環境がKubenetesでまるっと起動するようにしている。
...
### [組織の拡大に伴うアジャイルなプロダクト組織構築 : KAKKA is not 閣下](http://kakkablog.hatenadiary.jp/entry/2019/04/05/085657)

組織構築の考え方や課題、規模に合わせた方法論、LeSS本の勧めなどが書かれている。
...
### [killercup/quicli : GitHubG](https://github.com/killercup/quicli)
