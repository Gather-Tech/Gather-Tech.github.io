...
フロントエンド開発を学べるワークショップコンテンツ。HTML、CSS、React、TypeScriptなどがひととおり学べる。MS製。

### [パスワードってどこにあるの？その1 : MBSD Blog](https://www.mbsd.jp/blog/20190514.html)

Windows内部でパスワードがどのように保存されていてどのように認証が行われているかについて書かれている。
...
### [JavaからKotlinに変換する7つのテクニック Kotlinらしさを生かした簡潔なコードに置き換えよう : エンジニアHub｜若手Webエンジニアのキャリアを考える！](https://employment.en-japan.com/engineerhub/entry/2019/05/14/103000)

JavaからKotlinらしいコードに書き換えるときのノウハウについて。nullチェックを簡潔に書く、data classを使う、シングルトンはobjectキーワードで実装するなど。
...
### [アルとAlgoliaと私 / alu_algolia : Speaker Deck](https://speakerdeck.com/vexus2/alu-algolia)

検索エンジンサービスのAlgoliaについて。Firestoreとの共存のさせ方、Algoliaにどういったデータをのせるか、Algoliaの嬉しいところ・つらいところなどが書かれている。
