...
開発組織の変革とそれに至るまでの詳細がきれいにまとめられています。組織の変革には地道に泥臭いことを粘り強くやっていかないといけないことが伝わってくる内容だと思いました。
...
### [ジョブ管理ツール「Rundeck」を導入した話 : WILLGATE tech blog](https://tech.willgate.co.jp/entry/2019/07/16/115000)

cronのジョブをRundeckに移行した話。一括してジョブを管理できるようになった、ログを一箇所で貯めることができるようになった、実行時間が一目で分かるようになったなどのメリットがある。

### [退屈なことはPythonにやらせる...前に考えるべきこと : Lean Baseball](https://shinyorke.hatenablog.com/entry/taikutsu-python)
...
Vue.jsをベースにしたフレームワーク。SPA、SSRアプリ、PWA、Electronアプリなどが同じコードベースで作れる。

### [testing-library/jest-dom: GitHub](https://github.com/testing-library/jest-dom)

DOMの状態をテストするためのJestのカスタムマッチャー。

### [ueokande/logbook: GitHub](https://github.com/ueokande/logbook)

Kubernetes上のコンテナのログをリアルタイムで見られるツール。Go製。
...
### [tomorrowkey/android-screen-record: GitHub](https://github.com/tomorrowkey/android-screen-record)

Androidの画面を録画してGIFファイルに変換してくれるCLIツール。
