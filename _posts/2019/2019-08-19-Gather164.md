...
### [Azure AD とエンタープライズ アプリケーションを SAML 連携する際のトラブルシュートのやり方について : Qiita](https://qiita.com/Shinya-Yamaguchi/items/2195fc79dacda89a8dad)

SAML連携するときのトラブルシュート方法について。SAMLリクエストの中身の見方などが書かれている。
...
自分自身も自分のやったことを細かに覚えていないし、マネージャーも覚えていないのでbrag document(要するにアピールシート)を2週間に1度くらいのペースで書いておくとよいという話。最後にテンプレートも紹介されている。
...
Pythonの歴史について。Pythonが作られた経緯、どのような用途で使われて成長してきたのか、今後の動向などについて書かれている。
...
コンテナ環境でのJVMヒープサイズの調整について。Java8とJava10においてのメモリ領域の判定方法、ヒープサイズ割合の調整方法についてなどが書かれている。
...
プライベートな日記サービス。気分も記録できて気分の変化の確認ができる。
